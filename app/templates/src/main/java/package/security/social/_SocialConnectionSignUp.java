 ...
 * @see <%=packageName%>.domain.User#getLogin()
 * @see <%=packageName%>.domain.ExternalAccount
 */
...
public class SocialConnectionSignUp implements ConnectionSignUp {
     ...
     * search for an ExternalAccount that matches and return the {@link <%=packageName%>.domain.User#getLogin() login}
